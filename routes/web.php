...
Route::post('/gia/reg', 'giaController@registration');
Route::get('/gia/adm/result', 'giaController@result')->name('admin.gia');
Route::post('/gia/adm/result/get', 'giaController@get_list');
Route::post('/gia/print/result/pers', 'giaController@printResultPers');
Route::post('/gia/print/result/all', 'giaController@printResultAll');
...
Route::middleware('authCheck')->group(function () {
    ...
    Route::post('/test/start', 'testController@start');
    ...
    Route::post('/test/result/short','testResultController@short');
    Route::post('/test/result/full','testResultController@full');
