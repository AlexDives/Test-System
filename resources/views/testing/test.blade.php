                        ...
                        <div class='card-body'>
                            <div class='row'>
                                ...
                                <div class='col-md-12 text-center mt-5'>
                                    ...
                                    @if( $role_id == 1 )
                                        <div class='text-center mt-5' onclick="st('full');" style="cursor:pointer;">
                                            пройти быстро
                                        </div>
                                        <div class='text-center mt-5' onclick="st('fix');" style="cursor:pointer;">
                                            исправить
                                        </div>
                                    @endif
                                </div>
            ...
            function st(t) {
                ...
                if (t == 'full') {
                    $.ajax({
                        ...
                        data: { tid: tid, ptid : {{$pers_test_id}} },
