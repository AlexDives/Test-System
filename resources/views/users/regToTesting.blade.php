            ...
            <div class="tab-content">
                <div class="tab-pane active" id="index1">
                    <ul class="side-menu toggle-menu">
                        ...
                        <li class="slide">
                            <a href="#" class="side-menu__item" onclick="saveUser();"><i class="side-menu__icon  fa fa-repeat"></i><span class="side-menu__label">Сохранить</span></a>
                        </li>
                        <li class="slide">
                            <a href="#" class="side-menu__item" onclick="deleteUser();"><i class="side-menu__icon  fa fa-file-text-o"></i><span class="side-menu__label">Удалить</span></a>
                        </li>						 
                    </ul>
                </div>
                <div class='btn-back'>
                    <a href="../editor" class="side-menu__item"><i class="side-menu__icon fa fa-angle-left"></i><span class="side-menu__label">Назад</span></a>
                </div>
            </div>
        </div>
    </aside>
            ...
            <div class='col-md-12'>
                <div class='row'>
                    <div class='col-md-12'>
                        <div class='card'>
                            <div class='card-body'>
                                <a href="#mainInfoUser" class="mainInfoUser-a">
                                    <div class="table-responsive" id="userTable" name="userTable">
                                    </div>
                                </a>
                            </div>
                        </div>
                                    ...
                                    <div class='row'>
                                        <div class='col-md-6'>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="login" placeholder="" id="login">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" class="form-control" name="password-two" placeholder="" id="password-two">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Секретный вопрос</label>
                                                <input type="text" class="form-control" name="secret_question" placeholder="" id="secret_question">
                                            </div>
                                        </div>
                                        <div class='col-md-6'>
                                            <div class="form-group">
                                                <label class="form-label">Фамилия</label>
                                                <input type="text" class="form-control" name="famil" placeholder="" id="famil">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="otch" placeholder="" id="otch">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Ответ на секретный вопрос</label>
                                                <input type="text" class="form-control" name="secret_answer" placeholder="" id="secret_answer">
                                            </div>
                                        </div>
                                    </div>
                                    <HR>
                                    <div class='row'>
                                        <div class='col-md-12'>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="workplace" placeholder="" id="workplace">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class='col-md-6'>
                                            <div class='form-group' style='margin: 35px 0px 0px 0px;'>
                                                <label class="custom-switch">
                                                    <input type="checkbox" name="is_block" id="is_block" class="custom-switch-input" checked > 
                                                    <span class="custom-switch-indicator"></span>
                                                    <span class="custom-switch-description">Активировать / Деактивировать</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
